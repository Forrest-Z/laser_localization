...
/* -------------------------------------------------------------------------------------------------------------- */
ArrayPoses kitti_transform_trajectory_frame(const std::vector<TrajectoryFrame> &trajectory, int sequence_id) {
...
public:
    ...
    std::vector<Point3D> DoNext(bool jump_frame = false) {
    ...
    std::vector<Point3D> NextBatch(bool jump_batch) {
