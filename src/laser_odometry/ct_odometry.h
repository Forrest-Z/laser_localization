#ifndef LASER_LOCALIZATION_CT_ODOMETRY_H
#define LASER_LOCALIZATION_CT_ODOMETRY_H
...
public:
    ...
    [[nodiscard]] std::vector<Eigen::Vector3d> GetVecLocalMap() const;
...
#endif //LASER_LOCALIZATION_CT_ODOMETRY_H
